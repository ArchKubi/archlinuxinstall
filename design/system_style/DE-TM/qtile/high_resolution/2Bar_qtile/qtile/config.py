...
#-:-------------------------------------------------------------------------:-#
    ...
    Key([mod, "shift"], "t", lazy.spawn("cool-retro-term -e htop")),
...
#-:-------------------------------------------------------------------------:-#
    ...
    Key([mod], "b", lazy.spawn("abrowser ")),
    Key([mod], "f", lazy.spawn("qutebrowser")),

    Key([mod], "r", lazy.spawn("dmenu_run -p 'GNU: '")),
    Key([mod, "control"], "space", lazy.spawn("rofi -show drun")),
...
#####################################################################################################################
layouts = [
    layout.Columns(margin=4, border_width=6, border_focus="#9d4edd", border_normal="#240046"),
