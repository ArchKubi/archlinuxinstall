...
################################################################################################################
read -rsn1 -p "###### AG YONETICISI#############################################" variable; echo
pacman -S networkmanager
systemctl enable NetworkManager.service
echo -n "ag yoneticisini etkinlesti "
...
read -rsn1 -p "$computer_name guzel isim //Press Enter" variable; echo
read -rsn1 -p "######################bitti:/Press-Enter#########################" variable; echo
################################################################################################################
...
################################################################################################################
read -rsn1 -p "###### ROOT/Yetkili SIFRESI ##############################################" variable; echo
...
read -rsn1 -p "//Press Enter" variable; echo
echo "once bu komutu girin 1: exit 2: umount /mnt/boot and umount /mnt"
